             ...
             <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                 <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-6">
                        ...
                        <a href="{{ route('competitions.create') }}" class="btn-add">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 flex justify-center">
                                            <a href="{{ route('competitions.show', $competition->id) }}" class="btn-view">
                                                Voir
                                            </a>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ route('competitions.edit', $competition->id) }}" class="btn-edit">
                                                Modifier
                                            </a>
