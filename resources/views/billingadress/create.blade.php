                ...
                <form action="{{ route('billingadress.store') }}" method="POST" class="p-6 max-w-sm mx-auto  rounded-xl shadow-md flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="border-2 border-gray-600 bg-gray-200 dark:bg-gray-700 text-black dark:text-white p-2 w-full" type="text" name="city" id="description" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="border-2 border-gray-600 bg-gray-200 dark:bg-gray-700 text-black dark:text-white p-2 w-full" type="text" name="state" id="description" required>
                        </div>

                        <div class="mb-4">
                            <label class="text-xl text-black dark:text-white" for="description">Etablissement:</label>
                            <input class="border-2 border-gray-600 bg-gray-200 dark:bg-gray-700 text-black dark:text-white p-2 w-full" type="text" name="etablisement" id="description" required>
                        </div>
                        <div class="mb-4">
                            <label class="text-xl text-black dark:text-white" for="description">Nom:</label>
                            <input class="border-2 border-gray-600 bg-gray-200 dark:bg-gray-700 text-black dark:text-white p-2 w-full" type="text" name="lastname" id="description" required>
                        </div>

                        <div class="mb-4">
                            <label class="text-xl text-black dark:text-white" for="description">Prenom:</label>
                            <input class="border-2 border-gray-600 bg-gray-200 dark:bg-gray-700 text-black dark:text-white p-2 w-full" type="text" name="name" id="description" required>
                        </div>
